    ...
    <section className="relative overflow-hidden">
      ...
      <div className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <h2 className="mt-3 text-3xl font-semibold text-primary">{dict.login.title}</h2>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-primary text-white shadow-lg">
          ...
          <div className="relative flex h-full flex-col justify-between p-10">
            <div className="space-y-4">
              <p className="text-xs uppercase tracking-[0.3em] text-neon">{dict.hero.eyebrow}</p>
              <h3 className="text-3xl font-semibold leading-tight">{dict.hero.title}</h3>
            ...
            <div className="mt-10 rounded-2xl border border-white/15 bg-white/10 p-6 backdrop-blur">
              <p className="text-sm font-semibold text-white">{dict.hero.cardTitle}</p>
